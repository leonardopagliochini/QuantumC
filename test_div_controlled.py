...
def main():
    ...
    rows = []
    vals = [-2, -1, 1, 2]
    print("div_controlled: testing a,b in {-2,-1,1,2}, control=1")
    for a in vals:
        for b in vals:
            if b == 0:
                continue
            print(f"div_controlled: a={a}, b={b}")
            ...
            rows.append(("div_controlled", a, a_bin, b, b_bin, exp_q, exp_q_bin, exp_r, exp_r_bin, q_val, q_bits, r_val, r_bits, (q_val == exp_q) and (r_val == exp_r)))
