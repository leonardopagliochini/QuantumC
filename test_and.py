...
def main():
    ...
    min_val = 0
    max_val = 1
    print(f"and: testing a and b in range {min_val}..{max_val}, {total} operations")
    ...
    tu.print_table(rows, csv_path="test_log/test_and.csv")
