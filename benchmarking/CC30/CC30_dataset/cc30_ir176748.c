int main(){
  ...
  if ((a + 25) < 26) { s = s + 1; } else { s = s - 1; }
  if ((b + 26) < 27) { s = s + 1; } else { s = s - 1; }
  if ((a + 27) < 28) { s = s + 1; } else { s = s - 1; }
  if ((b + 28) < 29) { s = s + 1; } else { s = s - 1; }
  if ((a + 29) < 30) { s = s + 1; } else { s = s - 1; }
  if ((b + 30) < 31) { s = s + 1; } else { s = s - 1; }
  if ((a + 31) < 32) { s = s + 1; } else { s = s - 1; }
sink = sink + a + b + c + s;
  return sink;
}
